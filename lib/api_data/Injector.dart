...
class Injector {
  ...
  Dio getDio(){
    ...
    _dio.options.headers["secret_key"] =  ApiConstants.secret_key;
    _dio.options.headers["publish_key"] =  ApiConstants.publish_key;
  ...
  static Options? getHeaderToken(){
    String? token = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJlbWFpbCI6InJhdm5lZXRAeW9wbWFpbC5jb20iLCJpZCI6MTgsImlhdCI6MTY3MjczODgxNH0.Aau6xIOGcdBufjN_JkLcsrrQ7P-5pYN5LYv2eKGAoAY";
    if (token != null) {
      print("token=$token");
      var headerOptions =
      Options(headers: {
      ...
      var headerOptions =
      Options(headers: {
        'publish_key' : ApiConstants.publish_key,
